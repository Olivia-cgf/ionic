...
/**
 * Generated class for the LostandfoudPage page.
 *
...
@Component({
  selector: 'page-lostandfoud',
  templateUrl: 'lostandfoud.html',
})
export class LostandfoudPage extends BaseUI{
  lostandfound: string = this.newMethod();  
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad LostandfoudPage');
  }
  presentActionSheet() {
